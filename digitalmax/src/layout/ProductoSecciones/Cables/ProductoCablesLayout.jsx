...
import './ProductoCablesLayout.css'
...
function ProductoCablesLayout() {    

    const [products, setProducts] = useState([]);
    const [loading, setLoading] = useState(true);
    const navigate = useNavigate();
    const handleProducto = (id) =>{
        navigate(`/app/productos/producto/cables/${id}`)
  ...
  function productoCategory(products) {
    const categoriaSeccion = products.filter((filtro) => filtro.categoria === 'Cables' || filtro.categoria === 'cables' );
...
export default ProductoCablesLayout
