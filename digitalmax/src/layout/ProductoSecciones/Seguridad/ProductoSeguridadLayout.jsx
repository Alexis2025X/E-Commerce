...
import './ProductoSeguridadLayout.css'
...
function ProductoSeguridadLayout() {    

    const [products, setProducts] = useState([]);
    const [loading, setLoading] = useState(true);
    const navigate = useNavigate();
    const handleProducto = (id) =>{
        navigate(`/app/productos/producto/seguridad/${id}`)
  ...
  function productoCategory(products) {
    const categoriaSeccion = products.filter((filtro) => filtro.categoria === 'Seguridad' || filtro.categoria === 'seguridad' );
...
export default ProductoSeguridadLayout
